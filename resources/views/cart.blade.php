            ...
            <div class="table-responsive cart-info">
                <table class="table">
                    ...
                    <tbody>
                        <tr>
                            <td class="image">
                                <a href="product-detail.html"><img src="images/product/p11-268x268.jpg" alt="Cashmere cuff vintage Levi maxi" title="Cashmere cuff vintage Levi maxi" />
                                </a>
                            </td>
                            <td class="name"><a href="product-detail.html">Cashmere cuff vintage Levi maxi</a>
                                <br /> <small>Color: Pink</small> </td>
                            <td class="product-price">$158.00</td>
                            <td class="quantity">
                                <div class="input-group btn-block" style="max-width: 100px;">
                                    <button onclick="changeQty('0',0); return false;" class="decrease"><i class="fa fa-minus"></i>
                                    </button>
                                    <input id="select-number0" type="text" name="quantity[]" value="2" size="1" class="form-control" />
                                    <button onclick="changeQty('0',1); return false;" class="increase"><i class="fa fa-plus"></i>
                                    </button>
                                </div>
                            </td>
                            <td class="total">$316.00</td>
                            <td class="remove">
                                <button type="submit" data-toggle="tooltip" title="Update" class="btn btn-update"><i class="fa fa-refresh"></i>
                                </button>
                                <button type="button" data-toggle="tooltip" title="Remove" class="btn btn-remove"><i class="fa fa-times"></i>
                                </button>
                            </td>
                        </tr>
                    </tbody>
        ...
        <div class="panel-group cart-module" id="accordion">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="input-group">
                            ...
                            <span class="input-group-btn">
                                <input type="button" value="Apply Coupon" id="button-coupon" data-loading-text="Loading..."  class="btn btn-gray" />
                            </span>
                        </div>
                    </div>
                </div>
            ...
            <div class="panel panel-default col-sm-4 col-xs-12">
                ...
                <div id="voucher" class="">
                    <div class="panel-body">
                        <label class="control-label" for="input-voucher">Enter your gift voucher code here</label>
                        <div class="input-group">
                            <input type="text" name="voucher" value="" placeholder="Enter your gift voucher code here" id="input-voucher" class="form-control" />
                            <span class="input-group-btn">
                                <input type="submit" value="Apply Voucher" id="button-voucher" data-loading-text="Loading..."  class="btn btn-gray" />
                            </span>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="panel-body">
                        ...
                        <form class="form-horizontal">
                            ...
                            <div class="required">
                                ...
                                <input type="text" name="postcode" value="" placeholder="Post Code" id="input-postcode" class="form-control" /> </div>
                            <input type="button" value="Get Quotes" id="button-quote" data-loading-text="Loading..." class="btn btn-gray" />
                        </form>
                    </div>
                </div>
            </div><!-- /.panel -->
        ...
        <div class="cart-total">
            <table>
                ...
                <tr>
                    ...
                    <td class="right">$316.00</td>
                </tr>
            </table>
        </div><!-- /.cart-total -->
        <div class="buttons">
            <div class="pull-left"><a href="index-2.html" class="btn btn-gray">Continue Shopping</a>
            </div>
            <div class="pull-right"><a href="checkout.html" class="btn btn-blue">Checkout</a>
            </div>
        </div>
    </div><!-- /#content -->
@endsection
