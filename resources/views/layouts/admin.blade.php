...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="{{url('/')}}" class="logo">
      ...
      <span class="logo-lg"><b>Drug</b>Store</span>
    </a>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li>
          ...
          {{-- <ul class="treeview-menu">
            <li><a href="pages/layout/top-nav.html"><i class="fa fa-user-secret"></i>Admins</a></li>
            <li><a href="pages/layout/boxed.html"><i class="fa fa-user"></i> Customers</a></li>
            <li><a href="pages/layout/fixed.html"><i class="fa fa-user-md"></i> Doctors</a></li>
          </ul> --}}
        </li>
        <li>
          <a href="pages/widgets.html">
            <i class="fa fa-hospital-o"></i> <span>Medicines</span>
          </a>
        </li>
        <li>
          <a href="pages/widgets.html">
            <i class="fa fa-user-md"></i> <span>Requested Medicines</span>
        ...
        {{-- <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="pages/charts/chartjs.html"><i class="fa fa-circle-o"></i> Unverified Prescriptions</a></li>
            <li><a href="pages/charts/morris.html"><i class="fa fa-circle-o"></i> Verified Prescriptions</a></li>
            <li><a href="pages/charts/flot.html"><i class="fa fa-circle-o"></i> Paid Prescriptions</a></li>
            <li><a href="pages/charts/inline.html"><i class="fa fa-circle-o"></i> Shipped Prescriptions</a></li>
            <li><a href="pages/charts/inline.html"><i class="fa fa-circle-o"></i> Deleted Prescriptions</a></li>
            <li><a href="pages/charts/inline.html"><i class="fa fa-circle-o"></i> All Prescriptions</a></li>
          </ul>
        </li> --}}
        {{-- <li class="treeview">
          <a href="#">
...
<!-- ChartJS -->
<script src="{{url('/')}}/backend/bower_components/Chart.js/Chart.js"></script>
