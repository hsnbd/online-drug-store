  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active"><a href="#"><i class="fa fa-th "></i> <span>My prescriptions</span></a></li>
        <li><a href="#"><i class="fa fa-shopping-cart"></i> <span>Awaiting shipping</span></a></li>
        <li><a href="#"><i class="fa fa-truck"></i> <span>Shipped orders</span></a></li>
